...
const Home = () => {
  ...
  return (
    <section id="home" className="-mt-16 pt-16 lg:mt-0 lg:pt-0" data-scroll-section>
      <div className="grid relative h-1/2-screen lg:h-screen">
        ...
        {breakpoints.lg &&
          <a href="#about" className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10">
